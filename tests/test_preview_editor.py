...
class ProgressLayoutTests(unittest.TestCase):
    ...
    def test_preview_progress_is_light_gray_in_the_top_bar(self):
        ...
        self.assertIn("chapterTitleAt", PREVIEW_EDITOR.HTML_TEMPLATE)
        self.assertIn("chapterTitleWindows", PREVIEW_EDITOR.HTML_TEMPLATE)
        self.assertIn("is-scrolling", PREVIEW_EDITOR.HTML_TEMPLATE)
